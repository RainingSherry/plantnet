...
| cell-specific mixing coefficient | Analytic coefficient $g_i$ controlling the amount of neighbor mixing | perturbation budget, learned gate, uncertainty gate | Use this direct term in prose; $g_i$ is analytic and static. |
...
| bounded graph-vicinal anchor recovery | Title-level description of the shared F/T framework | universally topology-robust recovery | Foreground the property established by analysis; treat robustness as conditional. |
