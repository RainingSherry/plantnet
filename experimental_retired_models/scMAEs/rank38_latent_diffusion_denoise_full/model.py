...
class LatentDiffusionDenoiseScMAE(nn.Module):
    """scMAE encoder with a lightweight latent DDPM epsilon predictor."""
    ...
    def predict_eps(self, z_t: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        return self.eps_head(torch.cat([z_t, time_embedding(t, self.time_dim)], dim=1))
