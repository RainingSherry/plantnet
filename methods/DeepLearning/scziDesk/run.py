# -*- coding: utf-8 -*-
"""
scziDesk: Single-cell Zero-Inflated Density Estimator (Placeholder)
================================================================
...
def _check_deps():
    ...
    if missing:
        raise ImportError(
            f"scziDesk requires {', '.join(missing)} but it is not installed.\n"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='scziDesk: Single-cell Zero-Inflated Density Estimator [env-blocked]',
...
def main():
    ...
    raise NotImplementedError(
        "scziDesk full implementation not yet migrated. "
        "See: reference"
    )
