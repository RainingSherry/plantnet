...
CONFIG = VariantConfig(
    name="008_pseudo_agree_neighbormix",
    method_name="scMAE_plus_pseudo_agree_neighbormix",
    description="Original scMAE backbone with pseudo-cluster-agreement filtered NeighborMix.",
