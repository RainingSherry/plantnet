...
CONFIG = VariantConfig(
    name="007_soft_reliable_neighbormix",
    method_name="scMAE_plus_soft_reliable_neighbormix",
    description="Original scMAE backbone with reliability-weighted first-neighbor NeighborMix.",
