...
CONFIG = VariantConfig(
    name="005_neighbormix_prototype",
    method_name="scMAE_plus_neighbormix_prototype",
    description="Original scMAE backbone with NeighborMix and delayed DEC prototype alignment.",
