...
CONFIG = VariantConfig(
    name="012_boundary_protected_neighbormix",
    method_name="scMAE_plus_boundary_protected_neighbormix",
    description="Original scMAE backbone with delayed NeighborMix and boundary/rare-cell edge protection.",
