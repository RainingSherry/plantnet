...
METHODS_DIR = os.path.dirname(os.path.dirname(THIS_DIR))
...
def parse_args():
    ...
    # Other arguments
    parser.add_argument('--seed', type=int, default=2211,
                        help='Random seed')
...
def main():
    ...
    # Use the HVG-aligned normalized/log layer so ZINB inputs match X.shape.
    raw_counts = adata.layers['norm_log'] if 'norm_log' in adata.layers else adata.X
